...
export default function Ravynset() {
  return (
    <section className="section bg-black py-24 overflow-hidden">
      <div className="container">
        ...
        <div className="flex flex-col items-center gap-8 text-center">
          <p className="servicios-rotating-text !mt-0">
          ...
          <Magnet distance={0.2} stiffness={200} damping={20}>
            <a
              href={WA_HREF}
              target="_blank"
              rel="noopener noreferrer"
              className="servicio-cta !m-0"
            >
